...
void LIOInterface::updateCloudMapOdometry(
  ...
  // Merge colored and non-colored point clouds
  pcl::PointCloud<pcl::PointXYZ> colored_pcl, nocolor_pcl;
  pcl::fromROSMsg(*colored_cloud, colored_pcl);
  pcl::fromROSMsg(*nocolor_cloud, nocolor_pcl);

  ld_->lidar_cloud_ = colored_pcl + nocolor_pcl;  // Merge both clouds
